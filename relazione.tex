...
In un primo momento è stato modellato il sottoschema illustrato in Figura \ref{schema_piccolo1}.
...
esclusivamente dall'entità TERAPIA, dipende anche dal periodo di applicazione, quindi non è sufficiente creare una nuova relazione tra TERAPIA e DIAGNOSI.
...
Per comodità, il risultato di tale trasformazione è riportato in Figura \ref{schema_piccolo2}.
...
Nella fase logica verrà mostrato che questa relazione può essere trasformata, senza perdita d'informazione, e con l'aggiunta di una nuova entità, in relazioni binarie.

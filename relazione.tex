...
In Figura \ref{schema_piccolo3} si può vedere il risultato di tale trasformazione.
...
\end{itemize}
A questo punto, osservando nuovamente i sottoschemi in Figura \ref{schema_piccolo2} ed in Figura \ref{schema_piccolo3}, è chiaro che modellino ogni possibile situazione:
\begin{itemize}

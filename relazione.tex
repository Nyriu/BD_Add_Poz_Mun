...
\iffalse
  ...
  query semplici sulle entità ?

  INSERT INTO paziente (cf, nome, cognome, ...)
  VALUES ('AAAAAA00A00A000A', 'Mario', 'Rossi', ...)
  ...
  SELECT *
  FROM paziente
  WHERE cf = 'AAAAAA00A00A000A';

  UPDATE paziente
  SET nome =  'Marco', cognome = 'Bianchi', ...
  WHERE cf = 'AAAAAA00A00A000A';
  ...
  ****
  ...
  LEFT JOIN terapia_prescritta tp on d.cod_dia = tp.diagnosi
  ...
  ****
  ...
  SELECT t.cod_ter, COUNT(*)
  FROM terapia t
  LEFT JOIN terapia_prescritta tp on t.cod_ter = tp.terapia
  GROUP BY t.cod_ter
  ORDER BY COUNT(*) DESC

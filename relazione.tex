...
\begin{itemize}
    ...
    \item MOTIVA-TERAPIA: una relazione ternaria in cui partecipano le entità
          TERAPIA e DIAGNOSI in un meccanismo di causa-effetto. 
\end{itemize}                  
...
Il modo in cui è stata definita l'entità TERAPIA ci permette di modellare il
requisito \textit{ogni terapia può curare più patologie}.  Risulta chiaro,
quindi, che un'informazione come data di inizio, o data di fine, o medico
...
differente, pena la perdita delle informazioni predicenti.  D'altra parte non è

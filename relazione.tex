...
\subsubsection{Le Relazioni}
    \begin{itemize}
        ...
        \item MOTIVA-TERAPIA:   
              ...
              una relazione ternaria in cui partecipano le entità
              TERAPIA e DIAGNOSI in un meccanismo di causa-effetto. In particolare
              dall'analisi dei requisiti emerge che ad ogni diagnosi può essere 
              associata nessuna o, al più, una terapia mentre la terapia viene 
              prescritta al fine di curare più patologie relative a diagnosi 
              distinte. Di conseguenza la partecipazione di DIAGNOSI è parziale 
              e quella di TERAPIA totale considerando 
              
              % VINCOLI ESTERNI  
              % RICAPITOLANDO FLUSSO

...
\begin{itemize}
  ...
  \item il secondo riguardante la data in cui viene effettuata la diagnosi in quanto deve essere compresa tra la data di inizio e quella di fine del ricovero.

...
\end{lstlisting}
Lo EXISTS permette di verficiare che il paziente abbia assunto almeno due volte lo stesso farmaco.
...
\begin{itemize}
  \item Non è troppo lungo in quanto, in caso contrario, questo comportebbe un maggior numero di operazioni di lettura sul disco.
...
\begin{figure}[!ht] % TODO abbellire
  ...
  \label{fig:grafico_1} %TODO rifare bello, piu qualita e rettangolare
\end{figure}

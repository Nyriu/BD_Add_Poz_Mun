...
% TODO fare abbreviazioni consistenti con quelle fatte su SQL
...
\begin{tikzpicture} % TODO abbellire
  ...
  \draw[-latex] (terapiaprescritta.one south) -- ++(0,-0.6) -| ($(terapiaprescritta.one south) + (7.5,-0.6)$) |- ($(terapia.one south) + (0,-0.6)$) -| ($(terapia.one south) + (0,0)$);
  \draw[-latex] (terapiaprescritta.two south) -- ++(0,-0.2) -| ($(terapiaprescritta.two south) + (5,0)$) |- ($(diagnosi.one south) + (-0.2,-0.8)$) -| ($(diagnosi.one south) + (-0.2,0)$);
  \draw[-latex] ($(terapiaprescritta.two south) + (-0.2,0)$) -- ++(0,-0.4) -| ($(terapiaprescritta.two south) + (5.2,0)$) |- ($(diagnosi.one south) + (0,-0.6)$) -| ($(diagnosi.one south) + (0,0)$);

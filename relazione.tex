...
Richiesta:
Si vogliono raccogliere informazioni riguardo alla durata in giorni dei ricoveri per tumore rispetto agli altri tipi di ricovero
...
\begin{figure}[!ht] % TODO abbellire
  ...
  \caption{Confronto tra la durata dei ricoveri per tumore e i gli altri tipi di ricovero}
  \label{fig:grafico_5}
\end{figure}
\cleardoublepage
